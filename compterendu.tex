...
\newcommand{\reporttitle}{ TODO }%Etude sur la consommation et les
 % importations de gaz naturel}     % Titre
\newcommand{\reportauthor}{ TODO }%Guillaume \textsc{Palvadeau},\\Christophe  \textsc{Pelet}} % Auteur
\newcommand{\reportsubject}{ TODO }%Projet - séries temporelles - M2 SAF} % Sujet
...
\begin{document}
 ...
 \include{latex_files/others/title}
...
\listoftables   % table des tableaux
  ...
  %\cleardoublepage
  \include{latex_files/intro}  
  \cleardoublepage
  \include{latex_files/partie1}
  \cleardoublepage
...
\appendix
\section{Annexe}
\input{./latex_files/annexe}
\cleardoublepage
   \include{latex_files/references}
