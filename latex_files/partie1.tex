...
La valeur obtenue par la méthode des moments est: $\widehat{\rho}^{MM} = 0,514$.
...
\begin{tabular}{| l | c | c | c | c | c |}
 ...
 \hline  
 \end{tabular}
\captionof{table}{Estimations des paramètres pour la copule de Clayton}
\label{tab1}
\end{center}
...
\begin{tabular}{| l | c | c | c | c | c |}
 ...
 \hline  
 \end{tabular}
\captionof{table}{Estimations des paramètres pour la copule de Gumbel}
\label{tab2}
\end{center}
...
\begin{tabular}{| l | c | c | c | c | c |}
 ...
 \hline  
 \end{tabular}
\captionof{table}{Estimations des paramètres pour la copule de Frank}
\label{tab3}
\end{center}
...
\begin{tabular}{| l | c | c | c | c | c |}
 ...
 \hline  
 \end{tabular}
\captionof{table}{Estimations des paramètres pour la copule normale}
\label{tab4}
\end{center}
...
\begin{tabular}{| l | c | c | c | c | c |}
 ...
 \hline  
 \end{tabular}
\captionof{table}{Estimations des paramètres pour la copule de Student}
\label{tab5}
\end{center}
...
Le K-plot de la copule de Student estimée est similaire à celui de la copule normale.
...
En appliquant l'algorithme du bootstrap paramétrique pour la famille des copules de Gumbel, on obtient, pour un seuil de 0,05, $D_n = 0,0383 > 0,0301 = L$. On obtient une p-value de $0,01$. Avec la fonction \lstinline!gofCopula!, on obtient une p-value de $0,02547$. 
