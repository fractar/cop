...
Nous traçons dès lors le Chi-plot sur notre échantillon de données.

\noindent%
\begin{figure}[H]
    \begin{center}
      \includegraphics[width=14 cm, angle=0]{./pictures/chi_plot_empir.png}
      \centering\caption{Chi-plot empirique}
    \end{center}
\end{figure}
...
Nous pouvons maintenant tracer le K-plot sur notre échantillon de données.
...
\begin{figure}[H]
    \begin{center}
      ...
      \centering\caption{Histogramme 3D sur une grille 10 X 10 des données}
    \end{center}
\end{figure}
