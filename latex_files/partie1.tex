...
$$
\widehat{\lambda_L}\left(\frac{i}{n}\right) = \frac{C_n(\frac{i}{n},\frac{i}{n})}{\frac{i}{n}}
$$
...
Le graphique 3D d'une copule empirique tel que tracé sur le graphique 18 est difficilement exploitable.
